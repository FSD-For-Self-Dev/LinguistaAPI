...
class TestLanguagesEndpoints:
    ...
    def test_create_native(self, auth_api_client, user, languages):
        language_name = languages(name=True)[0]
        source_data = [
            {
                'language': language_name,
            }
    ...
    def test_create_native_amount_limit(self, auth_api_client, user, languages):
        language_names = languages(
            name=True,
            _quantity=UsersAmountLimits.MAX_NATIVE_LANGUAGES_AMOUNT + 1,
        )
        source_data = [
            {
                'language': language_name,
